...
public class ArrayList<E> extends AbstractList<E>
    ...
    public void add(int index, E element) {
        ...
        elementData[index] = element;   //将指定位置的元素替换为传入的元素
        size++;
    }
    ...
    public void clear() {
        modCount++;
        for (int i = 0; i < size; i++)
            elementData[i] = null;  //设置为null让gc回收
        size = 0;
    }
    ...
    public boolean addAll(Collection<? extends E> c) {
        Object[] a = c.toArray();
        int numNew = a.length;
        ensureCapacityInternal(size + numNew);  //确保容量，不够就扩容
        System.arraycopy(a, 0, elementData, size, numNew);  //将a数组拷贝到elementData数组的size位置
        size += numNew;
        return numNew != 0;
    }
    ...
    public boolean addAll(int index, Collection<? extends E> c) {
        ...
        if (numMoved > 0)
            //先将elementData数组从index位置拷贝到index+numNew位置
